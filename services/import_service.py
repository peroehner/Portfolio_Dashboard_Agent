...
class ImportService:
    ...
    def _normalize_symbol_record(self, details: dict[str, Any]) -> dict[str, Any]:
        ...
        mapping = {
            ...
            "tradeBelowPrice": ("tradeBelowPrice", "trade_below_price"),
            "tradeBelowShares": ("tradeBelowShares", "trade_below_shares"),
            "tradeAbovePrice": ("tradeAbovePrice", "trade_above_price"),
            "tradeAboveShares": ("tradeAboveShares", "trade_above_shares"),
