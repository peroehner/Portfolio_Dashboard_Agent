...
class LLMClient:
    ...
    def _overlay_system_prompt(self, symbol: str = "") -> str:
        return (
            ...
            "it means in THIS book (levels, notes, Intent, PT Horizon / personal target "
            "timeframe, weight vs cap, dividend gap, harvest/tax facts). "
            "When personal.targetHorizonYears is set, treat personal.targetPrice as a "
            "thesis over that horizon — do not narrate a multi-year PT as if it were a "
            "1Y must-hit; near-term catalysts are checkpoints inside the horizon. "
            "Watch-outs must cite specific personal facts (your sell-above, weight, "
            "Intent, PT Horizon, harvest alert, note catalyst) — not generic market commentary. "
