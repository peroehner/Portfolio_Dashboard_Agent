...
class LLMClient:
    ...
    def _overlay_system_prompt(self, symbol: str = "") -> str:
        return (
            ...
            "When personal.targetHorizonAt (or targetHorizonLabel) is set, treat "
            "personal.targetPrice as a thesis ending on that date — do not narrate a "
            "multi-year PT as if it were a 1Y must-hit; near-term catalysts are "
