...
MIGRATION_STATEMENTS: tuple[str, ...] = (
    ...
    "ALTER TABLE symbols DROP COLUMN IF EXISTS target_horizon_years",
    "ALTER TABLE symbols ADD COLUMN IF NOT EXISTS target_horizon_at DATE",
    "ALTER TABLE symbols ADD COLUMN IF NOT EXISTS target_basis_at DATE",
    "ALTER TABLE symbols ADD COLUMN IF NOT EXISTS target_basis_price DOUBLE PRECISION",
